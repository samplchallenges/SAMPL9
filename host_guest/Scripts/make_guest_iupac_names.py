...
"""Quick Python script to process guest smiles and generate IUPAC names for the compounds."""
...
dirnames = [ '/home/amezcum1/SAMPL9/host_guest/WP6/', '/home/amezcum1/SAMPL9/host_guest/bCD/' ]
prefixes = [ 'WP6' , 'bCD']
