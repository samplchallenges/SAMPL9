...
# ============================================================================
# STATISTICAL ESTIMATORS FOR CATEGORICAL PREDICTIONS
# ============================================================================
...
#if we get a divide by zero error, due to TP+FP=0 or TP+FN=0, modify the behavior using `zero_division=1`
# def f1_score(data, zero_division):
#     x, y = (data.astype(bool)).T
#     if zero_division == None:
#         f1 = f1_score(y_true=x, y_pred=y, average='binary')
#     else:
#         f1 = f1_score(y_true=x, y_pred=y, average='binary', zero_division=zero_division)
#     return f1
...
def mcc(data):
    """
    Also known as phi coefficient. In essence is a correlation coefficient from -1 to 1 
    
    Notes:
    +1 represents perfect predictions
...
def j(data):
    """
    Youden's J Statistic for imbalanced datasets.
